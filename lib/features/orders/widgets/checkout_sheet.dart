        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: [
                // Left Side: Order Summary & Quick Cash
                Expanded(
                  flex: 5,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 8),
                              _SummaryRow('Tax (${settings.taxRatePercent}%)', tax, settings.currencySymbol),
                              const Padding(
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  const Text('Amount Due', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                                  Text(
                        ...
                        if (_selectedMethod == 'CASH') ...[
                          ...
                          Wrap(
                            ...
                            children: [
                              _QuickCashPill(
                                amount: total, 
                                label: 'Exact', 
                                isSelected: _tenderedAmount == total,
                                onTap: () => setState(() => _tenderedAmount = total),
                              ),
                              ..._quickCashAmounts.map((amt) {
                                if (amt < total) return const SizedBox.shrink();
                                return _QuickCashPill(
                                  amount: amt, 
                                  label: Currency.format(amt, symbol: settings.currencySymbol), 
                                  isSelected: _tenderedAmount == amt,
                                  onTap: () => setState(() => _tenderedAmount = amt),
                                );
                              }),
                            ],
                          ),
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                const Text('Change Due:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                Text(
                                  Currency.format((_tenderedAmount - total).clamp(0, double.infinity), symbol: settings.currencySymbol),
                                  style: TextStyle(
                                    fontSize: 24,
                                    fontWeight: FontWeight.w900,
                                    color: Theme.of(context).colorScheme.primary,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              FilledButton(
                                onPressed: cartState.isSaving ? null : () => _confirm(context, paid: true),
                              ...
                              if (cartState.orderType == 'DINE_IN' && (cartState.tableNumber?.isNotEmpty ?? false)) ...[
                                const SizedBox(height: 8),
                                TextButton(
                                  onPressed: cartState.isSaving ? null : () => _confirm(context, paid: false),
...
class _SummaryRow extends StatelessWidget {
  ...
  const _SummaryRow(this.label, this.amount, this.symbol, {this.isError = false});
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(
          Currency.format(amount, symbol: symbol),
          style: TextStyle(
            fontSize: 16, 
            fontWeight: FontWeight.bold,
